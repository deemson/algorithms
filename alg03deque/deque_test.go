...
func forEachAlgorithm[T any](t *testing.T, f func(t *testing.T, deque alg03deque.Deque[T])) {
	deques := map[string]alg03deque.Deque[T]{
		"ArrayDeque":  alg03deque.Array[T](2),
		"LinkedDeque": alg03deque.Linked[T](),
	}
...
func TestDeque_GetOutOfBounds(t *testing.T) {
	forEachAlgorithm[int](t, func(t *testing.T, deque alg03deque.Deque[int]) {
